...
for (ic in 1:10) {
  ...
  system.time(
    out <- lassosum.pipeline(
      cor = ifelse(err, -gwas$z, gwas$z) / sqrt(length(ind.gwas)),
...
# 1    0.7208358       5990   0.7195996       5909 0.7427696 556873    0.7244605      193712
# 2    0.6740187      21344   0.6832889      28531 0.7173350 551776    0.7151347      287567
# 3    0.6889644      13998   0.7015143      18981 0.7187687 430862    0.7276862      193119
# 4    0.7014369       6862   0.7047542       5072 0.7312275 551608    0.7238057      289188
# 5    0.6937752       6455   0.7075190       2597 0.7314310 540406    0.7174551      287784
# 6    0.7084239      10220   0.7151113       4624 0.7419574 528332    0.7362119      287121
# 7    0.7190179       5516   0.7137930      23163 0.7469418 549308    0.7404853      192923
# 8    0.6866592      12846   0.7027708       2404 0.7163345 551635    0.7132981      291181
# 9    0.6948183       6692   0.7086798       2906 0.7446229 534640    0.7106697      388577
# 10   0.6871929      20441   0.7114027       2426 0.7279022 546629    0.7057103      388898
#
# 1 0.698 [0.689-0.706] 0.707 [0.7-0.712]    0.732 [0.725-0.739]    0.722 [0.715-0.728]
# 2  11000 [7760-14700] 9640 [4240-15900] 534000 [509000-550000] 280000 [241000-320000]
