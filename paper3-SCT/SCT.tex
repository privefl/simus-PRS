...
We use variants from the UK Biobank imputed dataset that have a minor allele frequency larger than 1\% and an imputation INFO score larger than 0.3. There are almost 10M such variants, we randomly choose 2M of them.
...
This is achieved by varying the number of causal variants (100, 10K, or 1M), and the disease heritability $h^2$ (30\% or 60\%). [NO HLA?? WE SHOW PLR MUCH BETTER FOR THIS]
