...
For breast cancer, for a large grid of the 4 hyper-parameters, the maximum AUC on the training set is \textasciitilde64\% (Figure \ref{fig:BC}). If using default parameters (i.e.\ $r_{c}^2$ = 0.1 or 0.2; $w_c \le 500$; liberal threshold of 0.3 on imputation INFO score), the maximum AUC is \textasciitilde63\%. 
