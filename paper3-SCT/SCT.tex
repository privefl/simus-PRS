...
\begin{tabular}{|l|c|c|c|c|c|}
  \hline
Trait & UKBB size & GWAS size & \#SNPs in GWAS & Citation \\
  \hline
...
Type 1 diabetes (T1D) & 768 / 314,570 & & & \\
...
\caption{Breast cancer. Scatter plot of new effect sizes resulting from SCT versus initial effect sizes of GWAS. Only non-zero effects are represented. Red line corresponds to the 1:1 line.}
\label{fig:eff-BC}
\end{figure}
